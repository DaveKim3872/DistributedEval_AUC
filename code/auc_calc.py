...
test_root = "../tri_class/10_models/"
test100_shuffle_path = '../tri_class/auc_testset/shuffle/'
av_path = '../tri_class/auc_testset/csv/10average/'
res100_path = '../tri_class/auc_testset/csv/100csv/'
cnt = 1
...
for number in range(0, 10):
    ...
    for i in range(1, 100):
        ...
        root="../tri_class/10_models/model"+ str(number) +"/"
